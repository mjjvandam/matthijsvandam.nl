...
Laatste auditbasis: huidige repo op 2026-09-07.
...
- 40 publieke pagina's in `sitemap.xml`.
- 40 pagina's in `PUBLICATIE_REGISTER.json`: 40 `geverifieerd` en 0 `review_nodig`.
