...
| MTP-1 artrodese | `behandelingen/mtp-1-artrodese.html` | publiek, `review_nodig` | Terug naar `behandelingen.html`, `hallux-rigidus.html`, `disclaimer.html` | `showInPainGuide: false`; geen pijnwijzeruitkomst | ADR-0003, ADR-0005, ADR-0006 |
