...
<fieldset><legend>Wat past bij jou?</legend><div class="audiences"><label><input type="radio" name="audience" value="patienten" required> Ik ben patiënt</label><label><input type="radio" name="audience" value="zorgprofessionals" required> Ik werk in de zorg</label></div></fieldset>
