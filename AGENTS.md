...
Bouw matthijsvandam.nl uit tot een moderne persoonlijke professionele website voor Matthijs van Dam:
orthopedisch chirurg in Tilburg en zorgconsultant, met focus op voet/enkel/sportletsel,
...
- Er zijn twee doelgroepen: patienten en zorgprofessionals.
- Patientennieuwsbrief: algemeen informatief, begrijpelijk, geen individueel medisch advies.
- Professionele nieuwsbrief: verdieping over onderzoek, onderwijs, zorginnovatie en implementatie.
- Geen echte nieuwsbriefdienst koppelen zonder expliciete toestemming.
- Geen API-keys of accountkoppelingen in de repo zetten.

## Techniek

- Dit is nu een lokale statische conceptsite.
- Publiceer niets en koppel geen domein zonder expliciete toestemming.
- Controleer na wijzigingen: layout, mobiele weergave, interne links, consolefouten, nieuwsbriefstructuur en medische veiligheidsgrenzen.
...
- nieuwsbriefstructuur met expliciete toestemming;
