...
## Generatieve AI in Zoeken

Controleer bij de weekcheck of voor de bestaande domeinproperty het Search Console-rapport **Generative AI performance (Search)** beschikbaar is. Dit rapport toont vertoningen in AI Overviews en AI Mode; vergelijk een vaste periode alleen met een even lange voorafgaande periode en noteer de rapportdatum. Bekijk bij voldoende gegevens welke publieke pagina's vertoningen krijgen. Koppel een opvallende pagina aan de gewone Web-prestaties en URL-inspectie voordat je een SEO-actie voorstelt. Houd deze bronnen gescheiden: het AI-rapport bewijst geen klik, rankingverbetering of medische kwaliteit.

Ontbreekt het rapport of zijn waarden afgeschermd wegens weinig gegevens, leg dat als `niet beschikbaar` vast en vul geen nul in. Voeg geen speciaal AI-schema, `llms.txt` of zoekwoordvarianten toe enkel voor AI-zichtbaarheid. Geef voorrang aan indexeerbaarheid, duidelijke zichtbare inhoud, betrouwbare bronnen en veilige interne routes. Wijzig medische tekst, metadata of publieke status alleen via de bestaande review- en publicatieregels.
