...
Het startoverzicht kan een gedateerde, bewijsgebonden tip tonen op basis van de opgeslagen Vercel- en Search Console-momentopnamen. De tip houdt Google-klikken en Vercel-bezoekers en hun verschillende perioden apart, vermeldt de bronperiode en doet alleen een kleine controlevoorstel. Er draait geen automatische providercontrole of sitewijziging. De tip kan verwijzen naar een al bestaand idee in Frisse blik; zij maakt geen nieuw idee of taak aan.
